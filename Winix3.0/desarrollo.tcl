...
if [ catch {source winix_clase.tcl} resultado ] {
  puts "Problemas cargando la clase winix base $resultado : $::errorInfo"
  exit
}
...
#if [ catch {source winix_carga_master.tcl} resultado ] {
#	puts "Problema muy grave $::errorInfo"
#}
